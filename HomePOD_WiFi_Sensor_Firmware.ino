 ...
 *    - NOTE: Required for JSON formatting
 *
 ...
 * RASPBERRY PI SETUP:
 * -------------------
 * 1. Run the included Python server script on your Raspberry Pi
 * 2. Find the Pi's IP address: hostname -I
 * 3. Update RASPBERRY_PI_IP below with your Pi's IP
 * 4. Update WIFI_SSID and WIFI_PASSWORD with your network credentials
 *
 * UPLOAD SETTINGS:
 * ----------------
...
#define WIFI_SEND_INTERVAL 10000     // Send data to Pi every 10 seconds
...
void sendDataToRaspberryPi() {
    ...
    sensors["audio_level"] = sensorData.audioLevel;
    sensors["audio_peak"] = sensorData.audioPeak;
